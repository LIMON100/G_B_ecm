...
class _AmarpayScreenState extends State<AmarpayScreen> {
  ...
  amarpay() {
    ...
    String _initial_url =
        "${AppConfig.BASE_URL}/amarpay?payment_type=${widget.payment_type}&combined_order_id=${_combined_order_id}&amount=${widget.amount}&user_id=${user_id.$}&package_id=${widget.package_id}";
