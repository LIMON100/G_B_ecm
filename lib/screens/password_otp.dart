...
//   PasswordOtp({Key? key, this.verify_by = "email", this.email_or_code, this.phone_number, this.email})
//       : super(key: key);
...
//         await AuthRepository().getPasswordConfirmResponse(code, password, widget.phone_number);
//
...
class _PasswordOtpState extends State<PasswordOtp> {
  ...
  onPressConfirm() async {
    ...
    var passwordConfirmResponse = await AuthRepository().getPasswordConfirmResponse(
        widget.verify_by == "email" ? code : "", password, widget.phone_number);
