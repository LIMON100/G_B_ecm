...
import 'package:ecom_flutter/data_model/category.dart';
...
class _ClassifiedProductEditState extends State<ClassifiedProductEdit> {
  ...
  setConstDropdownValues() {
    videoType.addAll([
      CommonDropDownItem("youtube", "Youtube"),
      CommonDropDownItem("dailymotion", "DailyMotion"),
      CommonDropDownItem("vimeo", 'Vimeo'),
    ]);
  ...
  getCategories() async {
    ...
    if (tmpCategory != null && tmpCategory != "" && categories.isNotEmpty) {
      categories.forEach((element) {
        if (element.value == tmpCategory) {
  ...
  getBrands() async {
    ...
    if (tmpBrand != null && brands.isNotEmpty) {
      brands.forEach((element) {
        if (element.value == tmpBrand) {
  ...
  bool requiredFieldVerification() {
    if (productNameEditTextController.text.trim().toString().isEmpty) {
      ...
      ToastComponent.showDialog("Product description Required",
  ...
  setProductValues() async {
    ...
    videoProvider = selectedVideoType == null ? "" : selectedVideoType!.key;
  ...
  setInitialValue(productInfo) {
    // setting general data
    productNameEditTextController.text = productInfo.name ?? "";
    tmpBrand = productInfo.brand!.name;
    getBrands();

    tmpCategory = productInfo.category;
    getCategories();
    unitEditTextController.text = productInfo.unit ?? "";
    setCondition(productInfo.condition);
    locationTextController.text = productInfo.location ?? "";
    tags.clear();
    if (productInfo.tags!.isNotEmpty) {
      tags.addAll(productInfo.tags!);
    }
    ...
    if (productInfo.thumbnailImage!.data!.isNotEmpty) {
      thumbnailImage = productInfo.thumbnailImage!.data!.first;
    }

    if (productInfo.pdf!.data!.isNotEmpty) {
      pdfSpecification = productInfo.pdf!.data!.first;
    }

    // set price data
    unitPriceEditTextController.text = productInfo.unitPrice ?? "";
    metaTitleTextController.text = productInfo.metaTitle ?? "";
    metaDescriptionEditTextController.text = productInfo.metaDescription ?? "";
    if (productInfo.metaImage!.data!.isNotEmpty) {
      metaImage = productInfo.metaImage!.data!.first;
    }
  }
  ...
  getProductCurrentValues() async {
    ...
    var productResponse =
        await ProductRepository().getClassifiedProductsDetails(
      widget.productId,
    );
    ...
    if (productResponse.success!) {
      ...
      setInitialValue(productResponse.data![0]);
    }
  }
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      itemSpacer(),
                      _buildDropDownField('Brand', (value) {
                        selectedBrand = value;
                        setChange();
                      }, selectedBrand, brands),
                      itemSpacer(),
                      _buildDropDownFieldWithChildren('Categories', (value) {
                        selectedCategory = value;
                        setChange();
                      }, selectedCategory, categories),
                      itemSpacer(),
                      buildEditTextField("Product Unit", "Product Unit",
                      ...
                      itemSpacer(),
                      buildEditTextField(
                          "Location", "Location", locationTextController,
                          isMandatory: true),
                      itemSpacer(),
                      buildTagsEditTextField(
                          "Tags", "Tags", tagEditTextController,
                          isMandatory: true),
                      itemSpacer(),
                      buildGroupItems(
                        'Description ',
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      itemSpacer(),
                      chooseSingleImageField("Thumbnail Image",
                          (onChosenImage) {
                      ...
                      buildGroupItems(
                          "Video form",
                          _buildDropDownField("Video Url", (newValue) {
                      ...
                      //   setChange();
                      // }, pdfSpecification),
                      chooseSingleFileField("Pdf Specification", "",
                          (onChosenFile) {
      ...
      children: [
        Column(
          ...
          children: [
            ...
            fileField("document", onChosenFile, selectedFile)
          ],
        ),
      ],
    );
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      itemSpacer(),
                      chooseSingleImageField("Meta Image", (onChosenImage) {
