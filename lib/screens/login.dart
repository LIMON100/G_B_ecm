...
import 'package:ecom_flutter/screens/password_forget.dart';
import 'package:ecom_flutter/screens/registration.dart';
import 'package:ecom_flutter/social_config.dart';
...
class _LoginState extends State<Login> {
  ...
  onPressedLogin() async {
    ...
    // Print the current login method
    print("Current login method: $_login_by");

    if (_login_by == 'phone') {
      print("Inside phone condition...");
    ...
    else if (_login_by == 'email') {
      print("Inside email condition...");
    ...
    print("Performing login for $_login_by with password...");

    // Call the login method with the appropriate data
    var loginResponse = await AuthRepository().getLoginResponse(
