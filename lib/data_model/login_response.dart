...
class User {
  User({
    ...
    this.phone,
    this.emailVerified,
    this.phoneVerified, // Add this line
  });
  ...
  String? phone;
  bool? emailVerified;
  bool? phoneVerified; // Add this line
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
    ...
    phoneVerified: json["phone_verified"], // Add this line
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "phone_verified": phoneVerified, // Add this line
  };
}
