...
//   }
  static bool _isMailVerifiedRoute(Widget widget) {
    ...
    needsVerification = <Type>[SelectAddress, Address, Profile].any((element) => widget.runtimeType == element);
    if (is_logged_in.$ && needsVerification && SystemConfig.systemUser != null) {
      return !(SystemConfig.systemUser!.phoneVerified ?? true); //Check phoneVerified instead of emailVerified
    }
    return false;
  }
}
